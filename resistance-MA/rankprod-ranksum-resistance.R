...
# load TE-MA results and compare 3 MA
res.meta.resist.df.05.8stud <- readRDS('data/res-meta-resist-df-05-8stud.rds')

ggVennDiagram(list(TE_MA = rownames(res.meta.resist.df.05.8stud), 
...
print(paste('Correlation TE-MA - RankProd MA', cor(meta.comp.rankprod[
...
print(paste('Correlation TE-MA - RankProd MA', cor(meta.comp.rankprod[
                                                ...
                                                meta.comp.rankprod[
                                                 meta.comp.rankprod$lfc < 0, 2], 
                                                method = 'pearson') )) 
print(paste('Correlation TE-MA - RankSum MA', cor(meta.comp.ranksum[
...
# load TE-MA results and compare 3 MA
res.meta.resist.subA.df.05.5st <- 
                            readRDS('data/res-meta-resist-subA-df-05-5st.rds')

ggVennDiagram(list(TE_MA = rownames(res.meta.resist.subA.df.05.5st), 
...
## rankprod
meta.comp.rankprod.subA <- merge(res.meta.resist.subA.df.05.5st[
             res.meta.resist.subA.df.05.5st$adj.pval < 0.05, 'lfc', drop = FALSE],
...
## ranksum
meta.comp.ranksum.subA <- merge(res.meta.resist.subA.df.05.5st[
           res.meta.resist.subA.df.05.5st$adj.pval < 0.05, 'lfc', drop = FALSE],
...
# plots
# first merge data
meta.compare.subA <- merge(res.meta.resist.subA.df.05.5st[,'lfc', drop = FALSE],
...
# correlation: effect sizes MA (TE-MA) vs. RankProd or RankSum
print(paste('Correlation TE-MA - RankProd MA', cor(meta.comp.rankprod.subA[
...
print(paste('Correlation TE-MA - RankSum MA', cor(meta.comp.ranksum.subA[
...
# load TE-MA results and compare 3 MA
res.meta.resist.subB.df.05.3st <- 
                           readRDS('data/res-meta-resist-subB-df-05-3st.rds')

ggVennDiagram(list(TE_MA = rownames(res.meta.resist.subB.df.05.3st), 
...
## rankprod
meta.comp.rankprod.subB <- merge(res.meta.resist.subB.df.05.3st[
                                                        , 'lfc', drop = FALSE],
...
# ranksum
meta.comp.ranksum.subB <- merge(res.meta.resist.subB.df.05.3st[
       res.meta.resist.subB.df.05.3st$adj.pval < 0.05, 'lfc', drop = FALSE],
...
# plots
# first merge data
meta.compare.subB <- merge(res.meta.resist.subB.df.05.3st[,'lfc', drop = FALSE],
...
# correlation: effect sizes MA (TE-MA) vs. RankProd or RankSum
print(paste('Correlation TE-MA - RankProd MA', cor(meta.comp.rankprod.subB[
...
print(paste('Correlation TE-MA - RankSum MA', cor(meta.comp.ranksum.subB[
